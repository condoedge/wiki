    ...
    <div class="knowledge-modal">
        <div class="knowledge-modal__container">
            <div class="knowledge-modal__card">
                <h5 class="knowledge-modal__title">{{__('wiki.help-title')}}</h5>
                <p class="knowledge-modal__message">{{__('wiki.help-message')}}</p>
                <a target="_blank" class="knowledge-modal__link" href="{{ route('knowledge.articles', ['id' => $page->id]) }}">{{__('wiki.go-to-help-page')}}</a>
